        ...
        <>
            <article className=' w-[85%] m-auto font-[Merriweather] '>
                <section className=' mb-4 '>
                    ...
                    <div
                        className="flex justify-end pr-10 pt-2 pb-2 "
                    >
                        <div
                    ...
                    <div className=' flex justify-around items-center'>
                        ...
                        <div className='flex items-center gap-6   px-1'>
                            ...
                            <Link
                                to="/signin"
                                className='text-[#86133a] text-[18px] font-semibold hover:text-[#f9b4ca]' >
                                SIGN IN
                            </Link>

                            <Link
                                to="/register"
                                className='text-rose-500 text-[18px] font-semibold hover:text-[#f9b4ca]  '>
                                REGISTER
                            </Link>
                        </div>
                    </div>
        ...
        <>
            <article className=' w-[85%] m-auto font-[Merriweather] '>
                <section className=' mb-4 '>
                    ...
                    <div
                        className="flex justify-between lg:justify-end pr-10 py-2 border "
                    >
